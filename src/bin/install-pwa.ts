 ...
 *
 * @see https://github.com/nicekiwi/stellar-drive for documentation
 */
...
function generateAppTypes(): string {
  return `/**
 * @fileoverview Type barrel — re-exports from stellar-drive plus app-specific types.
 *
 * Conventions used by stellar-drive tables:
