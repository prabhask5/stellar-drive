 ...
 */
export async function saveCrdtCheckpoint(docId) {
 ...
 * @param docId - Document/note ID
 */
export async function loadCrdtFromRemote(docId) {
    const doc = getCrdtDoc(docId);
    if (!doc) {
...
function scheduleCheckpoint(docId) {
 ...
 * @param docId - Document/note ID
 */
export function connectCrdtRealtime(docId) {
    ...
    channel.on('broadcast', { event: 'crdt' }, (payload) => {
 ...
 * @param docId - Document/note ID
 */
export async function disconnectCrdtRealtime(docId) {
    const entry = activeChannels.get(docId);
    if (!entry) {
 ...
 */
export function getCrdtSyncState(docId) {
 ...
 * @param docId - Document/note ID
 */
export function isCrdtRealtimeConnected(docId) {
